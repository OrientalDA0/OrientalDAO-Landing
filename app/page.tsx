...
export default function OrientalDAOLanding() {
          ...
          <nav className="flex items-center justify-between max-w-7xl mx-auto">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#team" className="text-gray-700 hover:text-primary transition-colors font-medium">
                Team
              </a> <a href="#about" className="text-gray-700 hover:text-primary transition-colors font-medium">
                About
              </a>
              <a href="#collaboration" className="text-gray-700 hover:text-primary transition-colors font-medium">
                Collaboration
              </a>
              <a href="#events" className="text-gray-700 hover:text-primary transition-colors font-medium">
                Events
              </a>
              <a href="#learn" className="text-gray-700 hover:text-primary transition-colors font-medium">
                Learn
              </a>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
          ...
          <div className="hover:shadow-lg transition rounded p-6 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm mb-4">Founder, Oriental DAO</p>
            <div className="flex gap-4">
              <a href="https://x.com/mishaldotrwa" target="_blank" rel="noopener noreferrer">
                <SiX className="w-5 h-5 text-black dark:text-gray-300" />
              </a>
              <a href="https://linkedin.com/in/mishalturkane" target="_blank" rel="noopener noreferrer">
  ...
  {/* Pratima Tandekar */}
          <div className="hover:shadow-lg transition rounded p-6 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm mb-4">Co-Founder, Oriental DAO</p>
            <div className="flex gap-4">
          ...
          <div className="hover:shadow-lg transition rounded p-6 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm mb-4">Devrel, Oriental DAO</p>
            <div className="flex gap-4">
              <a href="https://x.com/" target="_blank" rel="noopener noreferrer">
                <SiX className="w-5 h-5 text-black dark:text-gray-300" />
              </a>
          ...
          <div className="hover:shadow-lg transition rounded p-6 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm mb-4">Social Media & Strategy, <br /> Oriental DAO</p>
            <div className="flex gap-4">
              <a href="https://x.com/" target="_blank" rel="noopener noreferrer">
                <SiX className="w-5 h-5 text-black dark:text-gray-300" />
              </a>
          ...
          <div className="hover:shadow-lg transition rounded p-6 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm mb-4">Graphics Designer, <br /> Oriental DAO</p>
            <div className="flex gap-4">
              <a href="https://x.com/" target="_blank" rel="noopener noreferrer">
                <SiX className="w-5 h-5 text-black dark:text-gray-300" />
              </a>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="border-t border-white/20 pt-8 text-center">
              <p className="text-white/60 text-sm">
                © 2025 Oriental DAO. All rights reserved. Built with ❤️ by the community.
              </p>
            </div>
          </div>
        </footer>
